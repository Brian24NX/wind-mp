...
public class HttpCientConfig {
	...
	public RestTemplate restTemplate(ClientHttpRequestFactory httpRequestFactory) {
		...
		// 默认的RequestFactory是 SimpleClientHttpRequestFactory
		// 最底层使用 ==> sun.net.www.protocol.http.HttpURLConnection .restrictedHeaders
		// 不允许修改orign 字段，会导致失败需要header 传参orign的地方修改失败！
